...
/* File from https://gist.github.com/slowkow/92f021272e760d10d111d7fb72679276 */
/* This runs the update-data.py script when receiving a webhook from Github   */
...
switch (strtolower($_SERVER['HTTP_X_GITHUB_EVENT'])) {
    ...
    case 'push':
        ...
        shell_exec("python3 ../../update_data.py");
        break;
    default:
